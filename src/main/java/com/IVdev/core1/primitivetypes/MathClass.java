...
Например, необходимо хранить и использовать в программе числа, которые выходят за пределы допустимых значений для типов long и double.

можно использовать два дополнительных типа из пакета java.math:
